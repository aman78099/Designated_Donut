...
@designated_donut.route("/increase_cart/<int:product_id>", methods=["POST"])
...
@designated_donut.route("/decrease_cart/<int:product_id>", methods=["POST"])
...
@designated_donut.route("/remove_from_cart/<int:product_id>", methods=["POST"])
